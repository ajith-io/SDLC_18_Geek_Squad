...
def start():
    if now.hour >= 0 and now.hour < 12:
        w.printf("     Good Morning Welcome to our GS Companion")
        w.printf("         ..Always by your side..\n")
    elif now.hour >= 12 and now.hour <= 16:
        w.printf("     Good Afternoon Welcome to our GS Companion")
        w.printf("         ..Always by your side..\n")
    elif now.hour >= 17 and now.hour <= 19:
        w.printf("     Good Evening Welcome to our GS Companion")
        w.printf("         ..Always by your side..\n")
    else:
        w.printf("     Hope you had a Great Day Welcome to our GS Companion")
        w.printf("         ..Always by your side..\n")
